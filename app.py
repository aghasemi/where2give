...
It happens more than often that we have spare items or canned food that we no longer use, and on ther other hand don't think at all they should be thrown away. I had alwasy had the difficulty to find 
...
household appliances, furniture, and other non-monetary items. Please help complete this databse by going to [https://github.com/aghasemi/where2give]() and adding new organisations to the file 
`charities.tsv`.
